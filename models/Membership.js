...
const membershipSchema = new mongoose.Schema(
  {
    ...
    // Optional future restriction to a specific account/client
    accountId: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "Account",
      default: null,
...
/**
 * Unique membership per user per workspace/org
 */
membershipSchema.index({ userId: 1, orgId: 1 }, { unique: true });

/**
 * Helpful indexes for team management and permission checks
 */
